...
export class ExercistListPage extends React.PureComponent {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div>
        <Helmet>
          <title>练习记录</title>
          <meta name="description" content="练习记录"/>
        </Helmet>
        <Section>
...
const withReducer = injectReducer({key: 'exercistList', reducer});
const withSaga = injectSaga({key: 'exercistList', saga});
